...
contract Domains is ERC721URIStorage{
  ...
  constructor(string memory _tld) payable ERC721("Happy Naming Service" ,"HNS") {
    tld = _tld;
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Happy Naming Service", "image": "data:image/svg+xml;base64,',
